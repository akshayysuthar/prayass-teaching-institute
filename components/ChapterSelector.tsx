...
export function ChapterSelector({
  ...
  // Create a map of chapters and sort them by chapter number
  ...
  // Handle question selection and deselection
  ...
  // Update selected questions when they change
  useEffect(() => {
    onSelectQuestions(selectedQuestions);
  }, [selectedQuestions, onSelectQuestions]);

  // Update selected chapters when selected questions change
  useEffect(() => {
  ...
  // Reset selected questions and chapters
                            ...
                            {chapters.map((chapter) => (
                              <div key={chapter.id}>
                                <h5 className="text-md font-semibold mt-4">
                                  ...
                                  (Subject:{" "}
                                  {subjectDetails?.subject_name || subjectId})
                                </h5>
                                {sectionQuestions
